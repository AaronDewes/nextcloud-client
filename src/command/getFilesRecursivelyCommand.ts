...
const debug = debugInit.debug("GetFilesRecursivelyCommand");

import type Client from "../client.ts";
import type { File, Folder, FolderGetFilesOptions } from "../client.ts";
...
export default class GetFilesRecursivelyCommand extends Command {
  ...
  protected async onExecute(): Promise<void> {
    ...
    this.resultMetaData.timeElapsed = new Date().getTime() -
      startTime.getTime();
    return;
  }
