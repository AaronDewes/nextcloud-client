...
const debug = debugInit.debug("UploadFilesCommand");

import type Client from "../client.ts";
import type { File } from "../client.ts";
      ...
      for (const file of this.files) {
        ...
        try {
          ...
          try {
            ...
            this.resultMetaData.errors.push(
              `${file.targetFileName}: ${e.message}`,
            );
        ...
        this.percentCompleted = Math.round(
          countCompleted / this.files.length * 100,
        );
